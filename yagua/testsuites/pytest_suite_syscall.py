"""Yagua - Pytest Suite Handler (System Call Implementation).
...
# ============================================================================
# PYTEST SUITE SYSCALL
# ============================================================================


class PytestSuiteSyscall(TestSuiteABC):
    """Test suite handler for pytest-based projects using system calls.
    ...
    Unlike PytestSuite which uses pytest.main() API, this implementation
    invokes pytest as a system command, making it more isolated from the
    current Python environment and potentially more stable across different
    pytest versions.
    ...
    def __init__(self, work_path):
        """Initialize PytestSuiteSyscall with working directory.
